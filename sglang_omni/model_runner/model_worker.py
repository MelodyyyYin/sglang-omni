...
class ModelWorker:
    ...
    def update_weights_from_distributed(
        ...
        # note (Yue Yin): Length check is the one guard that matters — sglang zips names/dtypes/shapes and silently truncates to the shortest, under-broadcasting weights.
