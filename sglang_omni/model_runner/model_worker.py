...
def _resolve_nccl_port() -> int:
    ...
    try:
        ...
        # note (Yue Yin): some restricted CI / sandbox environments do not allow ephemeral socket
...
def _apply_model_worker_backend_policy(
    ...
    if (
        ...
        # note (Yue Yin): projected talker prefill has request-dependent FP8 dense GEMM shapes
