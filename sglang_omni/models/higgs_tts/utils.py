...
# note (Yue Yin): codec-vocab specials (inside the [N*V] codebook space, NOT the text vocab)
BOC_ID = 1024
EOC_ID = 1025

# note (Yue Yin): shared between audio_encoder + vocoder; one codec load saves ~1 GB VRAM
